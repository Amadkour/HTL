...
def realstreams2():
    dataset = {
        "sensor": ARFFParser("X:\\Ahmed\\faculty\\phd_implementation\\paper+2+ISA\\code\\dataset\\sensors.arff",
                             n_chunks=100, chunk_size=2000),
...
def synthetic_streams_8(random_state):
    # Variables
...
def synthetic_streams_10(random_state):
    # Variables
    distribution = [0.1, 0.08, 0.12, 0.1, 0.1, 0.1, 0.2, 0.2]
